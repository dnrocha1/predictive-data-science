...
#Quais foram as viagens mais caras dos parlamentares?
#Mais frequentes tipos de despesas no exterior
#fornecimento de alimentação parlamentar & divulgação de atividade parlamentar & manutenção de escritório de apoio
#viajantes de fins de semana
#viajantes de final de ano
#quem foi que gastou mais nas ferias
```{r}
